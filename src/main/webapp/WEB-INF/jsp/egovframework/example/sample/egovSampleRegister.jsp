...
<%@ taglib prefix="validator" uri="http://www.springmodules.org/tags/commons-validator" %><!-- 벨리데이터 테그 라이브러리를 등록 -->
...
<head>
    ...
    <!-- formName은q밸리게이터 xml에서 name와 동일해야한다  -->
...
<form:form commandName="sampleVO" id="detailForm" name="detailForm"><!-- 네임 아이디 네임 다 설정되어 있는것과 동일해아 한다 -->
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
